# Battlesnake com A* - Projeto 1 ECM502  🐍

Este trabalho realiza a implementação de uma inteligência artificial para o jogo [Battlesnake](http://play.battlesnake.com)  utilizando o algoritmo A*. O objetivo é criar uma estratégia eficiente para movimentar a cobra no tabuleiro, coletando comida e evitando colisões com outras cobras, bordas e perigos. Este projeto foi desenvolvido para a disciplina de Inteligência Artificial (ECM502).
...
![star_algoritimi](https://miro.medium.com/v2/resize:fit:1400/1*l0IkrbNLnkCB1VzDq2Qy7A.gif)
